    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('address_type',
                 models.CharField(choices=[('home', 'home'), ('billing', 'billing'), ('studio', 'studio')],
                                  max_length=100)),
            ...
            fields=[
                ...
                ('day_of_week', models.CharField(
                    choices=[('sunday', 'sunday'), ('monday', 'monday'), ('tuesday', 'tuesday'),
                             ...
                             ('saturday', 'saturday')], max_length=10)),
                ('schedule', models.CharField(
                    choices=[('8AM-10AM', '8AM-10AM'), ('10AM-12PM', '10AM-12PM'), ('12PM-3PM', '12PM-3PM'),
                             ('3PM-6PM', '3PM-6PM')], max_length=10)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('modified_at', models.DateTimeField(auto_now=True)),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('degree_type', models.CharField(blank=True, choices=[('associate', 'Associate Degree'),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('from_month', models.CharField(blank=True, choices=[('january', 'january'), ('february', 'february'),
                                                                     ('march', 'march'), ('april', 'april'),
                                                                     ('may', 'may'), ('june', 'june'), ('july', 'july'),
                                                                     ('august', 'august'), ('september', 'september'),
                                                                     ('october', 'october'), ('november', 'november'),
                                                                     ('december', 'december')], max_length=100,
                                                null=True)),
                ('from_year', models.IntegerField(blank=True, null=True)),
                ('to_month', models.CharField(blank=True, choices=[('january', 'january'), ('february', 'february'),
                                                                   ('march', 'march'), ('april', 'april'),
                                                                   ('may', 'may'), ('june', 'june'), ('july', 'july'),
                                                                   ('august', 'august'), ('september', 'september'),
                                                                   ('october', 'october'), ('november', 'november'),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender',
                 models.CharField(blank=True, choices=[('female', 'female'), ('male', 'male')], max_length=100,
                                  null=True)),
                ('avatar', models.ImageField(blank=True, null=True, upload_to=accounts.models.avatar_directory_path)),
                ('hear_about_us',
                 models.CharField(blank=True, choices=[('Google', 'Google'), ('Facebook', 'Facebook')], max_length=100,
                                  null=True)),
                ...
                ('languages',
                 django.contrib.postgres.fields.ArrayField(base_field=models.CharField(blank=True, max_length=100),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL,
                                             related_name='students', to='accounts.Parent')),
                (
                'user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('skill_level',
                 models.CharField(blank=True, choices=[('basic', 'basic'), ('advanced', 'advanced')], max_length=100,
                                  null=True)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('modified_at', models.DateTimeField(auto_now=True)),
                (
