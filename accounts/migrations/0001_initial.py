# Generated by Django 2.2.3 on 2019-07-18 06:25
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('qualif_virtuoso_recognition', models.BooleanField(default=False, verbose_name='Qualifications: Virtuoso Recognition')),
                ...
                ('qualif_young_children_experience', models.BooleanField(default=False, verbose_name='Qualifications: Young Children Experience')),
                ('qualif_repertoire_selection', models.BooleanField(default=False, verbose_name='Qualifications: Repertoire Selection')),
                ...
                ('rates_thirty_mins', models.DecimalField(blank=True, decimal_places=2, max_digits=10, null=True, verbose_name='Rates: 30 mins')),
                ('rates_forty_five_mins', models.DecimalField(blank=True, decimal_places=2, max_digits=10, null=True, verbose_name='Rates: 45 mins')),
                ('rates_sixty_mins', models.DecimalField(blank=True, decimal_places=2, max_digits=10, null=True, verbose_name='Rates: 60 mins')),
                ('rates_ninety_mins', models.DecimalField(blank=True, decimal_places=2, max_digits=10, null=True, verbose_name='Rates: 90 mins')),
            ],
            options={
                'abstract': False,
            },
